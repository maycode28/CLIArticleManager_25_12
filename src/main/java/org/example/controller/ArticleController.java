...
import org.example.ArticleManager.App;
...
public class ArticleController extends Controller {
    ...
    public void makeTestData() {
        ...
        articles.add(new Article(1, "2025-12-07 12:12:12", "2025-12-07 12:12:12", "제목 123", "내용 1","test1"));
        articles.add(new Article(2, Util.getNowStr(), Util.getNowStr(), "제목 23", "내용 2","test1"));
        articles.add(new Article(3, Util.getNowStr(), Util.getNowStr(), "제목 1234", "내용 3","test2"));
    }
}